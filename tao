...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window("Tên Hub","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------
Notification.Notify("Notification", "Thank You for Using Tên HUB.", "rbxassetid://10709761889", {
    Duration = 5,       
    Main = {
        Rounding = true,
    }
...
wait(6)
Notification.Notify("Notification", "If You Use Fluxus, TÊn HUB Will Optimize Fluxus Well.", "rbxassetid://10709761889", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }

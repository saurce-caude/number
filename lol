--Window:Minimize()
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/saurce-caude/number/main/LOL"))()
...
Tab1:AddTextBox({
  ...
  Tab1:AddTextBox({
    ...
    local chag = Tab1:AddDropdown({
      Name = "select",
      Description = "",
      Options = {"Background", "text", "ScrollBar","Theme","Stroke","label"},
      Default = "Background",
      Callback = function(Value)
        _G.RGB = Value
      end
